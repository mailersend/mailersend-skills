...
| [mailersend-mcp](skills/mailersend-mcp) | Monitor delivery health, audit email activity, and report open and delivery rates per email or template using the [MailerSend MCP server](https://github.com/mailersend/mailersend-mcp) |
